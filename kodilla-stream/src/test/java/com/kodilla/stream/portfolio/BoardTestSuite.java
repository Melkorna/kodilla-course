...
class BoardTestSuite {
    ...
    void testAddTaskListAverageWorkingOnTask(){
        ...
        System.out.println( "ilosc zadań DONE i TO DO:"+" "+longTask);
        ...
        System.out.println("Suma roznic dni zadań"+""+sumOFDays);

        double averageOfDays = sumOFDays/longTask;
        System.out.println("srednia dni :"+ " "+averageOfDays);
        Assertions.assertEquals(3,longTask);
        Assertions.assertEquals(30,sumOFDays);
        Assertions.assertEquals(10.0,averageOfDays);
